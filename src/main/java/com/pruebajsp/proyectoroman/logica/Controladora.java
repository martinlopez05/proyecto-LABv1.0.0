...
import com.pruebajsp.proyectoroman.persistencia.ControladoraPersistencia;
...
public class Controladora {
     ...
     *
     * @return Lista de objetos con la información del total de gastos por mes.
     */
    public List<Object[]> obtenerTotalGastosporMes() {
        return controlpersis.obtenerTotalGastosPorMes();
    }
