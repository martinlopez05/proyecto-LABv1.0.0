...
public class ControladoraPersistencia {
    ...
    public List<Object[]> obtenerDeudaTotalGastosPorMes() {
        return gastoJpa.getDeudaTotalPorMes();
    }
     ...
     * datos.
     */
    public void eliminarGasto(Long idGasto) throws NonexistentEntityException, com.pruebajsp.proyectoroman.exceptions.NonexistentEntityException {
        gastoJpa.destroy(idGasto);
    }

    public void editOdontologo(Odontologo odontologo) throws Exception {
        odonJpa.edit(odontologo);
    }
